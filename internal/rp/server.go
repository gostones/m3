...
func Serve(base, myid string, port, support int) {
	...
	// }
	closeIdleConnsPeriod = strconv.Itoa(int(proxy.DefaultCloseIdleConnsPeriod / time.Second))
	clsic, _ := parseDurationFlag(closeIdleConnsPeriod)
	// if err != nil {
	// 	flag.PrintDefaults()
	// 	os.Exit(2)
	// }
	...
	options := skipper.Options{
		...
		LoadBalancerHealthCheckInterval: defaultLoadBalancerHealthCheckInterval,
		//ReverseSourcePredicate:          reverseSourcePredicate,
		MaxAuditBody: defaultMaxAuditBody,
		//EnableBreakers:                  enableBreakers,
		//BreakerSettings:                 breakers,
		//EnableRatelimiters:              enableRatelimiters,
		//RatelimitSettings:               ratelimits,
		...
		MetricsListener:        supportListener,
		...
		//DisableMetricsCompatibilityDefaults: disableMetricsCompat,
		//ApplicationLogOutput:                applicationLog,
		ApplicationLogPrefix: defaultApplicationLogPrefix,
		//AccessLogOutput:                     accessLog,
		//AccessLogDisabled:                   accessLogDisabled,
		//AccessLogJSONEnabled:                accessLogJSONEnabled,
		//AccessLogStripQuery:                 accessLogStripQuery,
		...
		// API Monitoring:
		ApiUsageMonitoringEnable:                       defaultApiUsageMonitoringEnable,
		ApiUsageMonitoringRealmKey:                     defaultApiUsageMonitoringRealmKeys,
		ApiUsageMonitoringClientIdKeyName:              defaultApiUsageMonitoringClientKeys,
		ApiUsageMonitoringDefaultClientTrackingPattern: defaultApiUsageMonitoringDefaultClientTrackingPattern,
		...
		// OAuthCredentialsDir:            oauthCredentialsDir,
		// OAuthTokeninfoURL:              oauth2TokeninfoURL,
		OAuthTokeninfoTimeout:          defaultOAuthTokeninfoTimeout,
		OAuthTokenintrospectionTimeout: defaultOAuthTokenintrospectionTimeout,
		WebhookTimeout:                 defaultWebhookTimeout,
		// OIDCSecretsFile:                oidcSecretsFile,

		// connections, timeouts:
		IdleConnectionsPerHost: proxy.DefaultIdleConnsPerHost,
		CloseIdleConnsPeriod:   time.Duration(clsic) * time.Second,
		BackendFlushInterval:   defaultBackendFlushInterval,
		ExperimentalUpgrade:    defaultExperimentalUpgrade,
		// ExperimentalUpgradeAudit:     experimentalUpgradeAudit,
		ReadTimeoutServer:       defaultReadTimeoutServer,
		ReadHeaderTimeoutServer: defaultReadHeaderTimeoutServer,
		WriteTimeoutServer:      defaultWriteTimeoutServer,
		IdleTimeoutServer:       defaultIdleTimeoutServer,
		MaxHeaderBytes:          http.DefaultMaxHeaderBytes,
		// EnableConnMetricsServer:      enableConnMetricsServer,
		TimeoutBackend:               defaultTimeoutBackend,
		KeepAliveBackend:             defaultKeepaliveBackend,
		DualStackBackend:             true, //enableDualstackBackend,
		TLSHandshakeTimeoutBackend:   defaultTLSHandshakeTimeoutBackend,
		ResponseHeaderTimeoutBackend: defaultResponseHeaderTimeoutBackend,
		ExpectContinueTimeoutBackend: defaultExpectContinueTimeoutBackend,
		MaxIdleConnsBackend:          defaultMaxIdleConnsBackend,

		// swarm:
		// EnableSwarm:                       enableSwarm,
		// SwarmKubernetesNamespace:          swarm.DefaultNamespace,
		// SwarmKubernetesLabelSelectorKey:   swarm.DefaultLabelSelectorKey,
		// SwarmKubernetesLabelSelectorValue: swarm.DefaultLabelSelectorValue,
		// SwarmPort:                         swarm.DefaultPort,
		// SwarmMaxMessageBuffer:             swarm.DefaultMaxMessageBuffer,
		// SwarmLeaveTimeout:                 swarm.DefaultLeaveTimeout,
